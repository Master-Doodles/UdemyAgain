...
export default function ProfileFollowings({ activeTab }: Props) {
    ...
    const predicate = activeTab === 3 ? 'followers' : 'followings'; //depeding on the the predicate 
    const {profile, followings, loadingFollowings} = useProfile(id, predicate); //get the profile followings etc
